          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a <span className="bg-[#ff2056] px-2 text-white">Custom</span> Phone Case
              </h1>
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-[#ff2056]" />
              ...
              <div className="flex flex-col justify-between items-center sm:items-start mt-4">
                  <div className="flex gap-0.5">
                    <Star className="h-4 w-4 text-[#ff2056] fill-[#ff2056]"/>
                    <Star className="h-4 w-4 text-[#ff2056] fill-[#ff2056]"/>
                    <Star className="h-4 w-4 text-[#ff2056] fill-[#ff2056]"/>
                    <Star className="h-4 w-4 text-[#ff2056] fill-[#ff2056]"/>
                    <Star className="h-4 w-4 text-[#ff2056] fill-[#ff2056]"/>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
            <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
                <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                  What our <span className="relative px-2">customers <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-[#ff2056]"/></span> say
                </h2>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              <div className='flex gap-0.5 mb-2'>
                <Star className='h-5 w-5 text-[#ff2056] fill-[#ff2056]' />
                <Star className='h-5 w-5 text-[#ff2056] fill-[#ff2056]' />
                <Star className='h-5 w-5 text-[#ff2056] fill-[#ff2056]' />
                <Star className='h-5 w-5 text-[#ff2056] fill-[#ff2056]' />
                <Star className='h-5 w-5 text-[#ff2056] fill-[#ff2056]' />
              ...
              <div className='flex gap-4 mt-2'>
                ...
                <div className='flex flex-col'>
                  ...
                  <div className='flex gap-1.5 items-center text-zinc-600'>
                    <Check className='h-4 w-4 stroke-[3px] text-[#ff2056]' />
      ...
      <section>
        <MaxWidthWrapper className='py-24'>
          <div className='mb-12 px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl sm:text-center'>
              <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                ...
                <span className='relative px-2 bg-[#ff2056] text-white'>
                  your own case
                </span>{' '}
                now
              </h2>
          ...
          <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
            <li className='w-fit'>
              <Check className='h-5 w-5 text-[#ff2056] inline mr-1.5' />
            ...
            <li className='w-fit'>
              <Check className='h-5 w-5 text-[#ff2056] inline mr-1.5' />5 year
              print warranty
            </li>
